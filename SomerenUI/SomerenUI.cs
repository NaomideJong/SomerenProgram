...
namespace SomerenUI
{
    public partial class SomerenUI : Form
    {
        ...
        private void generateRevenueToolStripMenuItem(object sender, EventArgs e)
        {
            showPanel("Revenue");
        }
        ...
        private void GenerateRevenuePanel()
        {
            pnlRevenue.Show();

            /* while( dateOfPurchase > firstDate && dateOfPurchase < finalDate
             *  {
             *  foreach (row in generateRevenue)
             *      {
             *      total += drinkPrice * drinkValue * (drinkVAT * 0,01 + 1)
             *      }
             *      
             *      
             *
             *
             *  foreach (drinkValue in generateRevenue)
             *      {
             *      count += drinkValue
             *      }
             *  }
            ...
            {
                // catch a error when something went wrong with the UI
                MessageBox.Show("Something went wrong while loading: " + e.Message);
            }
        }
